...
const CategoriesRow = ({ onCategoryClick }) => {
  ...
  return (
    ...
    >
      <h2 className="text-3xl md:text-6xl font-extrabold text-center mb-20 text-black drop-shadow-lg select-none uppercase font-serif">
        Shop by Categories
      </h2>

      {/* Reduced gap from gap-11 to gap-3 for tighter card arrangement */}
      <div className="flex flex-wrap justify-center items-center gap-3">
        {categories.map((cat, index) => (
          <motion.div
            key={index}
            className="w-full sm:w-1/2 md:w-1/6 max-w-xs mx-auto"
          ...
          >
            <div className="flex flex-col items-center">
              ...
              >
                <div className="w-36 h-36 rounded-full bg-white flex items-center justify-center shadow-lg z-0">
                  <motion.img
                    ...
                    style={{
                      boxShadow: "0 0 0 6px rgba(34,197,94,0.15)", // Green soft shadow
                    }}
                    whileHover={{
                      scale: 1.13,
              ...
              <div
                className="font-bold text-[18px] md:text-[22px] text-gray-800 text-center mb-2 tracking-wide"
